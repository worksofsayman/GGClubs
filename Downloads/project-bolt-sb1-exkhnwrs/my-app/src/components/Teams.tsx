...
const TeamCard: React.FC<{ member: TeamMember }> = ({ member }) => (
    ...
    >
      {/* Member Image */}
      <div className="w-32 h-32 mb-4 rounded-full overflow-hidden border-2 border-white/30 shadow-lg">
...
const Teams: React.FC<TeamsProps> = ({ sections }) => (
  <section className="relative min-h-screen overflow-hidden py-16 bg-black">
    ...
    <div className="relative z-10 max-w-7xl mx-auto">
      <h1 className="text-5xl sm:text-6xl font-bold text-center text-white mb-16">
        Our Team
      </h1>
